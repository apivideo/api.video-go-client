...
func main() {
    ...
    res, err := client.RawStatistics.GetLiveStreamAnalytics(liveStreamId)
    if err != nil {
...
func main() {
    ...
    res, err := client.RawStatistics.ListPlayerSessionEvents(sessionId)
    if err != nil {
...
func main() {
    ...
    metadata := []string{"Inner_example"} // []string | Metadata and Dynamic Metadata filter. Send an array of key value pairs you want to filter sessios with.
    currentPage := int32(2) // int32 | Choose the number of search results to return per page. Minimum value: 1 (default to 1)
    pageSize := int32(30) // int32 | Results per page. Allowed values 1-100, default is 25. (default to 25)
    ...
    res, err := client.RawStatistics.ListSessions(videoId)
    if err != nil {
